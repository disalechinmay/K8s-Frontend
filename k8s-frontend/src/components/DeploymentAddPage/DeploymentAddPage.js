...
import ReplicasPage from "./ReplicasPage";
/*
...
class DeploymentAddPage extends Component {
	state = {
		currentPage: 1,
		totalPages: 6,
		resourceName: "",
			...
			<React.Fragment>
				<div className="step-form">
					...
					{this.state.currentPage === 4 && (
						<ReplicasPage
							resourceReplicas={this.state.resourceReplicas}
							renderNextPage={() => this.renderNextPage()}
							renderPreviousPage={() => this.renderPreviousPage()}
							setResourceReplicas={replicas =>
								this.setResourceReplicas(replicas)
							}
						/>
					)}
...
export default DeploymentAddPage;
