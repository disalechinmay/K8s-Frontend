        ...
        <Container className="margin-top-10 align-content-center">
          <Container>
                  ...
                  <Form.Group as={Row} controlId="exampleForm.ControlSelect1">
                    ...
                    <Col sm="8">
                      <Form.Control
                        ...
                        onChange={event => this.handleNamespaceChange(event)}
                      >
                        {/* Populates options of namespaces */}
                        {this.state.namespacesListSet &&
                          this.state.namespacesList.map(namespace => {
                            return (
                              <option
                                value={namespace}
                                key={namespace + "_NAMESPACE"}
                              >
                                {namespace}
                              </option>
                            );
            ...
            <Row>
                  ...
                  {this.sidebarOptions.map((sidebarOption, index) => {
                    return (
                      <Col xs={6} sm={6} md={12} lg={12}>
                        ...
                        >
                          <span className={sidebarOption.style}></span>
              ...
              <Col xs={12} sm={12} md={12} lg={9} className="margin-top-10">
                ...
                {this.state.sidebarOptionSelected === 1 && (
                  <NodesPage refreshState={() => this.refreshState()} />
                )}
